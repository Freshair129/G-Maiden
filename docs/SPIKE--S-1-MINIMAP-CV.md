...
> Source-of-truth ที่อ่าน (scope ที่ parent อนุญาต): `docs/02-Engineering-Spec.md` §1, `docs/03-Technical-Design-Document.md` §5 + Risk R-02.
> Artifact ที่รันได้: `spikes/s1-minimap-cv/` (Rust = production-representative; `node-equiv.mjs` = executable equivalent).
