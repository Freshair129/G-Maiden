...
- **For:** the concurrent G-Maiden backend session (owns [`gsi.rs`](file:///g:/G-Maiden/src-tauri/src/gsi.rs) / [`runtime.rs`](file:///g:/G-Maiden/src-tauri/src/runtime.rs) / [`cv/`](file:///g:/G-Maiden/src-tauri/src/cv/)).

## Ask (small)
The overlay kill banner ([`src/src/App.tsx`](file:///g:/G-Maiden/src/src/App.tsx)) now pops the **slain hero's portrait**, draws a red X over it stroke-by-stroke, then fades it to grayscale. It needs the **exact** victim hero.
...
## References
- Overlay: [`src/src/App.tsx`](file:///g:/G-Maiden/src/src/App.tsx) (Tick interface + the kill `useEffect`), [`src/src/index.css`](file:///g:/G-Maiden/src/src/index.css) (`gm-kill*`).
- Portrait helper (deck): [`src/src/heroPortrait.ts`](file:///g:/G-Maiden/src/src/heroPortrait.ts).
