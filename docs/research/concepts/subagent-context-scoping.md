...
> Asset classification: orchestrator reference only. This is background for least-privilege context design and should be loaded deliberately, not by default for small frontend worker prompts.
