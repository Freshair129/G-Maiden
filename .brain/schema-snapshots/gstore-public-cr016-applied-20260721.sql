...
CREATE TABLE IF NOT EXISTS "public"."gmad_download_audit" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "actor_id" "uuid",
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "gmad_download_audit_action_check" CHECK (("action" = ANY (ARRAY['batch_created'::"text", 'batch_published'::"text", 'batch_status_changed'::"text", 'queue_checked'::"text", 'download_issued'::"text"])))
);


ALTER TABLE "public"."gmad_download_audit" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."gmad_download_batches" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "label" "text" NOT NULL,
    ...
    "generation" "text" NOT NULL,
    "cohort_seq_start" integer NOT NULL,
    "cohort_seq_end" integer NOT NULL,
    "status" "text" DEFAULT 'draft'::"text" NOT NULL,
    "created_by" "uuid" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "published_at" timestamp with time zone,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "gmad_download_batches_artifact_path_check" CHECK ((("artifact_path" !~ '^/'::"text") AND ("artifact_path" !~ '(^|/)\.\.(/|$)'::"text"))),
    CONSTRAINT "gmad_download_batches_check" CHECK (("cohort_seq_end" >= "cohort_seq_start")),
    CONSTRAINT "gmad_download_batches_cohort_seq_start_check" CHECK (("cohort_seq_start" > 0)),
    CONSTRAINT "gmad_download_batches_generation_check" CHECK (("generation" = ANY (ARRAY['F'::"text", 'B'::"text", 'P'::"text"]))),
    CONSTRAINT "gmad_download_batches_label_check" CHECK ((("char_length"("label") >= 1) AND ("char_length"("label") <= 120))),
    CONSTRAINT "gmad_download_batches_release_id_check" CHECK ((("char_length"("release_id") >= 1) AND ("char_length"("release_id") <= 120))),
    CONSTRAINT "gmad_download_batches_status_check" CHECK (("status" = ANY (ARRAY['draft'::"text", 'published'::"text", 'paused'::"text", 'closed'::"text"])))
);


ALTER TABLE "public"."gmad_download_batches" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."gmad_download_grants" (
...
ALTER TABLE "public"."gmad_download_grants" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."gmad_download_audit"
    ADD CONSTRAINT "gmad_download_audit_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."gmad_download_batches"
    ADD CONSTRAINT "gmad_download_batches_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."gmad_download_grants"
    ADD CONSTRAINT "gmad_download_grants_pkey" PRIMARY KEY ("batch_id", "user_id");
...
CREATE INDEX "gmad_download_audit_created_idx" ON "public"."gmad_download_audit" USING "btree" ("created_at" DESC);



CREATE INDEX "gmad_download_batches_status_idx" ON "public"."gmad_download_batches" USING "btree" ("status", "generation", "cohort_seq_start", "cohort_seq_end");



CREATE INDEX "gmad_download_grants_user_idx" ON "public"."gmad_download_grants" USING "btree" ("user_id", "batch_id");
...
ALTER TABLE ONLY "public"."gmad_download_audit"
    ADD CONSTRAINT "gmad_download_audit_actor_id_fkey" FOREIGN KEY ("actor_id") REFERENCES "public"."profiles"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."gmad_download_audit"
    ADD CONSTRAINT "gmad_download_audit_batch_id_fkey" FOREIGN KEY ("batch_id") REFERENCES "public"."gmad_download_batches"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."gmad_download_audit"
    ADD CONSTRAINT "gmad_download_audit_subject_id_fkey" FOREIGN KEY ("subject_id") REFERENCES "public"."profiles"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."gmad_download_batches"
    ADD CONSTRAINT "gmad_download_batches_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."profiles"("id");



ALTER TABLE ONLY "public"."gmad_download_grants"
    ADD CONSTRAINT "gmad_download_grants_batch_id_fkey" FOREIGN KEY ("batch_id") REFERENCES "public"."gmad_download_batches"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."gmad_download_grants"
    ADD CONSTRAINT "gmad_download_grants_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
GRANT ALL ON TABLE "public"."gmad_download_audit" TO "service_role";



GRANT ALL ON TABLE "public"."gmad_download_batches" TO "service_role";



GRANT ALL ON TABLE "public"."gmad_download_grants" TO "service_role";
