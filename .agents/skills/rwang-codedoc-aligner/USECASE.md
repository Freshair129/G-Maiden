# USECASE — rwang-codedoc-aligner

ตัวอย่างการใช้งานจริง 3 สถานการณ์ของ skill [rwang-codedoc-aligner](SKILL.md) ในโปรเจกต์ G-Maiden
...
python .agents/skills/rwang-codedoc-aligner/scripts/chunk_and_align.py \
...
$fail = 0
foreach ($p in $pairs) {
  python .agents/skills/rwang-codedoc-aligner/scripts/chunk_and_align.py $p.code $p.doc
