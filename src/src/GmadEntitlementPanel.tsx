...
export default function GmadEntitlementPanel() {
  ...
  if (state === "eligible") return <section className="auth-panel signedin"><strong>G-Maiden Closed Beta active</strong><span>{decision?.gid} · Terms {decision?.terms?.version}</span></section>;
