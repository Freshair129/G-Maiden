              ...
              {visibleRows.map((entry) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span style={{ ...styles.rowAmount, color: positive ? "#31d0a0" : "#ff5c7a" }}>
                      {positive ? "+" : ""}
...
const styles: Record<string, React.CSSProperties> = {
  ...
  chipActive: { borderColor: "#64c7ff", color: "#9be7ff", background: "#16294a" },
  ...
  rowNote: { color: "#8fa6c0" },
  rowAmount: { fontSize: 12.5, fontWeight: 700, textAlign: "right" },
  rowBalance: { fontSize: 11, color: "#8fa6c0", textAlign: "right" },
  rowWhen: { fontSize: 11, color: "#8fa6c0", textAlign: "right" },
  ...
  receiptTitle: { fontSize: 13, fontWeight: 700, color: "#9be7ff", textTransform: "uppercase", letterSpacing: 0.4 },
  receiptRow: { display: "flex", justifyContent: "space-between", fontSize: 12.5, color: "#d8e6f2", gap: 10 },
  receiptCopy: {
    marginTop: 6,
    borderRadius: 10,
    fontSize: 12,
